...
storage_postEE  = "/eos/cms/store/group/phys_tau/irandreo/Run3_22_postEE_new/"
...
samples  = [
  ...
  # Other backgrounds
  M('OTHER','TbarBQ_t-channel',
    "TbarBQ_t-channel",
    store=storage_postEE,url=url,files=filelist,opts="useT1=True,zpt=True"),
  M('OTHER','TbarWplusto2L2Nu',
    "TbarWplusto2L2Nu",
    store=storage_postEE,url=url,files=filelist,opts="useT1=True,zpt=True"),
  M('OTHER','TbarWplustoLNu2Q',
    "TbarWplustoLNu2Q",
    store=storage_postEE,url=url,files=filelist,opts="useT1=True,zpt=True"),
  M('OTHER','TBbarQ_t-channel',
    "TBbarQ_t-channel",
    store=storage_postEE,url=url,files=filelist,opts="useT1=True,zpt=True"),
  M('OTHER','TWminusto2L2Nu',
    "TWminusto2L2Nu",
    store=storage_postEE,url=url,files=filelist,opts="useT1=True,zpt=True"),
  M('OTHER','TWminustoLNu2Q',
    "TWminustoLNu2Q",
    store=storage_postEE,url=url,files=filelist,opts="useT1=True,zpt=True"),
